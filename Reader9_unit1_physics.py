...
class Question_reader:
    ...
    def __init__(self,master,question_file,answer_file,AnswerIndex):
        ...
        p1 = PhotoImage(file='grade9\\physics\\vector1.png')
        l = Label(scroll_frame, image=p1)
        l.place(x=160, y=450)
        l.image = p1
        #===========
        p2 = PhotoImage(file='grade9\\physics\\vector2.png')
        l2 = Label(scroll_frame, image=p2)
        l2.place(x=160, y=835)
        l2.image = p2
...
#stopwatch class is the following
    ...
    def addimage(self):
        ...
        l.image=p1
#root = Tk()
#app=Question_reader(root,'grade9\\physics\\unit1_ques.txt','grade9\\physics\\unit1_ans.txt', [1,6,9,15,16,22,24,29,32,37])
#root.mainloop()
