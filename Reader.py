...
class Question_reader:
    ...
    def __init__(self,master,question_file,answer_file,AnswerIndex):
        ...
        ####################inserting image for specific readers#############
        '''
        p1 = PhotoImage(file='grade10\\mathematics\\unit1_1.png')
    ...
    def show_result(self):
        ...
        #____writing the correct answer_________
...
#stopwatch function is the following        
    ...
    def addimage(self):
        ...
        l.image=p1
#root = Tk()
#app=Question_reader(root,'grade10\\mathematics\\unit1_ques.txt','grade10\\mathematics\\unit1_ans.txt', [1,6,10,13])
#root.mainloop()
