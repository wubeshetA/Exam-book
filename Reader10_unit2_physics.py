...
class Question_reader:
    ...
    def __init__(self, master, question_file, answer_file, AnswerIndex):
        ...
        p1 = PhotoImage(file='grade10\\physics\\y&zcharge.png')
        l = Label(scroll_frame, image=p1)
        l.place(x=450, y=260)
        l.image = p1

        p2 = PhotoImage(file='grade10\\physics\\2_capa.png')
        l2 = Label(scroll_frame, image=p2)
        l2.place(x=150, y=835)
        l2.image = p2
    ...
    def addimage(self):
        ...
        l.image = p1
#root = Tk()
#app=Question_reader(root,'grade10\\physics\\unit2_ques.txt','grade10\\physics\\unit1_ans.txt', [2,7,11,14,17,22,26,31,33,39])
#root.mainloop()
